...
local function abs(vm)
    local num1 = vm.OperandStack:pop()
    vm.OperandStack:push(math.abs(num1))
    output("math.abs(%f)", num1)
...
local function ceiling(vm)
    local num1 = vm.OperandStack:pop()
    vm.OperandStack:push(math.ceil(num1))
    output("math.ceil(%f)", num1)
...
local function floor(vm)
    ...
    vm.OperandStack:push(math.floor(num1))
    output("math.floor(%f)", num1)
